...
import accessor.LookupService;

/**
 * Abstract class for the builder that defines the template for a builder
 *
 * @param <T> - builder's entity type
 */
            ...
            for (Accessor accessor : mandatory) {
                ...
                if (x == null) {
                    ...
                    if (defaultValue != null) {
                        ...
                        throw new RuntimeException("A mandatory field " + accessor + "is not populated and no default value is set for the accessor");
                    }
                }
            }
        }
